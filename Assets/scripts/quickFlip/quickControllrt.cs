...
public class quickControllrt : MonoBehaviour {
    public GameObject panelRate;
    public GameObject panelThanks;

    public static quickControllrt instance;
    [SerializeField]
    ...
    public void endG()
    {
        ...
        endScoreT.text = playerQ.instance.point + "";
        if(GameManager.instance._GetBestQ() < playerQ.instance.point)
        {
            GameManager.instance._SetBestQ(playerQ.instance.point);
        }
        bestT.text = GameManager.instance._GetBestQ() + "";
    }
