...
public class tempController : MonoBehaviour {
    ...
    public void endG()
    {
        ...
        endScoreT.text = playerTemp.instance.point + "";
        if(GameManager.instance._GetBestT() < playerTemp.instance.point)
        {
            GameManager.instance._SetBestT(playerTemp.instance.point);
        }
        bestT.text = GameManager.instance._GetBestT() + "";
    }
